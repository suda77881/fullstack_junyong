...
class UserDto{
	...
	public UserDto() { super(); this.no = cnt++;}	// 유저번호 = 값; 값넣고 1증가
	...
	public void setEmail(String email) { this.email = email; } public int getNo() { return no; }
...
//2. 콜렉션프레임워크 - 동적배열 ( List (ArrayList)★, set, map )
