...
class Mobile2{ 
	// 상태 : 멤버변수
    String   serialNo;	  // 인스턴트변수, heap area, new O , this, 생성자O
    static  int count=0;  // 클래스변수 , method	, new X , this X, 생성자X 지금당장바로~! 
    // 행위 : 멤버함수
    public Mobile2() {
    	// 객체를 한개씩 만들떄마다. 	serialNo에 / 숫자를 한개씩 증가시키는데 ++count
...
public static void main(String[] args) {
 ...
 System.out.println("m2의 제품번호 " + m2.serialNo);  //2	m2(2번지),뱐수명   ◆ 2030-2
 System.out.println("m3의 제품번호 " + m3.serialNo);  //3	m3(3번지),변수명 
